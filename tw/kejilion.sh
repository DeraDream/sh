...
linux_Settings() {
	...
	while true; do
	  ...
	  echo -e "${gl_kjlan}43.  ${gl_bai}SSH登入摘要管理 ${gl_huang}★${gl_bai}"
	  echo -e "${gl_kjlan}------------------------"
...
echo "------------------------"
echo -e "${gl_kjlan}腳本官網:${gl_bai}https://kejilion.sh            ${gl_kjlan}GitHub地址:${gl_bai}${gh_https_url}github.com/DeraDream/sh${gl_bai}"
echo "------------------------"
echo ""
}
...
while true; do
	...
	echo "更新日誌"
	echo "------------------------"
	echo "全部日誌:${gh_proxy}raw.githubusercontent.com/DeraDream/sh/main/kejilion_sh_log.txt"
	echo "------------------------"
