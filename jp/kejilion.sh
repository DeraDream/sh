...
echo "------------------------"
echo -e "${gl_kjlan}スクリプト公式サイト：${gl_bai}https://kejilion.sh            ${gl_kjlan}GitHub アドレス:${gl_bai}${gh_https_url}github.com/DeraDream/sh${gl_bai}"
echo "------------------------"
echo ""
}
...
while true; do
	...
	echo "変更ログ"
	echo "------------------------"
	echo "すべてのログ:${gh_proxy}raw.githubusercontent.com/DeraDream/sh/main/kejilion_sh_log.txt"
	echo "------------------------"
